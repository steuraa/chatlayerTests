...
describe('interpolate', () => {
    ...
    //added 2 extra tests
    it('should ignore an open delimiter without an opening delimiter', () => {
        const result = interpolate('Hi firstname}, how are you today?', { firstname: 'John' }, { leftDelimiter: '{', rightDelimiter: '}' })
        const expected = 'Hi firstname}, how are you today?'
        expect(result).toEqual(expected)
    })
    it('should interpolate multiple variables from the session object in mixed order', () => {
        const result = interpolate('Hi @@lastname@@ @@firstname@@, how are you today?', { firstname: 'John', lastname: 'Doe' }, { leftDelimiter: '@@', rightDelimiter: '@@' });
        const expected = 'Hi Doe John, how are you today?';
        expect(result).toEqual(expected)
    });
});
